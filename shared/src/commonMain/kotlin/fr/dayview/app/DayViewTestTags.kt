...
internal object DayViewTestTags {
    ...
    const val MiniFocusStop = "miniFocusStopButton"
    const val MiniFocusModal = "miniFocusModal"
    const val MiniFocusConfirm = "miniFocusConfirmButton"
    const val MiniFocusCancel = "miniFocusCancelButton"
    ...
    const val FocusQuickStart = "focusQuickStart"
    ...
    const val FocusResumeRitual = "focusResumeRitual"
    const val FocusClosureIntention = "focusClosureIntention"
    const val FocusExitDetourCategory = "focusExitDetourCategory"
    const val FocusExitDetourConfirm = "focusExitDetourConfirm"
    const val FocusExitCancel = "focusExitCancel"
    ...
    const val SyncFirstChoiceDialog = "syncFirstChoiceDialog"
    const val SyncFirstChoiceMerge = "syncFirstChoiceMerge"
